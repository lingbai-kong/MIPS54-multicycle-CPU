...
HD_PWD='G:/document/ComputerOrganizationDesign/CPU54/multicycleCPU54/multicycleCPU54.runs/DMEM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DMEM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DMEM.tcl
